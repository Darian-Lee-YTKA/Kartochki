...
struct CardListView: View {
    ...
    @State private var selectedCard: Card = Card(front: "something went wrong", back: "something went wrong", dueDate: Date(), id: "123")
...
//                            Spacer()
                    ...
                    .fullScreenCover(isPresented: $isAddCardPresented) {
                        CardCreateView(translationLanguage: language, deck: language)
                            .environment(authManager)
                    }
