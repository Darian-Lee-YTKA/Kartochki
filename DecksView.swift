                ...
                VStack {
                    ...
                    ScrollView {
                        ForEach(databaseManager.decks, id: \.self) { deck in
                            DeckRowView(currentView: $currentView, bindedLanguage: $bindedLanguage, databaseManager: $databaseManager, isShowingDeleteDeckAlert: $isShowingDeleteDeckAlert, edit: false, inLanguages: true, deck: deck)
                                .padding(.vertical, 15)
